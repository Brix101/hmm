...
func (s *UserServices) CreateUser(data *User) (*User, error) {
	// Generate a new UUID
...
func (s *UserServices) GetAll() (Users, error) {
	users := Users{}
...
func (s *UserServices) GetByID(userId uuid.UUID) (*User, error) {
	user := User{}
...
func (s *UserServices) GetByEmail(email string) (*User, error) {
	user := User{}
